...
// for (ind in itemList) {
//   console.log(itemList[ind]["title"]);
// }
// for (ind in itemList) {
//   console.log(itemList[ind]["price"]);
// }
// for (ind in itemList) {
//   console.log(itemList[ind]["rating"]["count"]);
// }
// const item = {};
...
function product(itemList) {
  ...
  for (let i = 0; i < itemList.length; i++) {
    ...
    item.title = itemList[i]["title"];
    item.price = itemList[i]["price"];
    item.count = itemList[i]["rating"]["count"];
